...
<body>
	...
	<div class="container" style="padding-top: 80px; padding-bottom: 30px;">
		<div class="row text-center">
			<div class="col">
				<h2 style="color: white;">{{$portfolio->name}}</h2>
			</div>
		</div>
	...
	<section class="gallery-section">
		<div class="row">
			...
			<div class="col-4" style="padding: 0px 2px 2px !important;">			
				<a class="gallery-item fresco" style="margin-bottom: 2px !important;" href="{{ Storage::url($item->image) }}" data-fresco-group="gallery">
